...
namespace FitKitApp.Migrations
{
    ...
    [Migration("20200825124334_MigracijaAdminPocetenUser")]
    partial class MigracijaAdminPocetenUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitKitApp.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FitKitApp.Models.AppUser", b =>
                {
                    b.HasOne("FitKitApp.Models.Coach", "Coach")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FitKitApp.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
